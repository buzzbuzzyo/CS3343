...
public class Main {
	...
	public static void main(String[] args) {
		...
		runOperation("createProduct yoyoSin 1 500");
		runOperation("showStatus");
		runOperation("fill 10000 300");
		runOperation("logout");
		runOperation("regCustomer tkleung 1234 Sam 2019/11/28 500");
		runOperation("login tkleung 1234");
		runOperation("showAllShop");
		...
		runOperation("removeFromTrolley 10001 2");
		runOperation("logout");
		runOperation("login cityu 1234");
		runOperation("remove 10001");
		runOperation("logout");
		runOperation("login tkleung 1234");
		runOperation("addToTrolley cityu 10001 10");
